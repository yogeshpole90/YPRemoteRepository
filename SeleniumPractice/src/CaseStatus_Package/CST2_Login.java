...
public class CST2_Login {
	...
	public static void log(String field, String testDesc, String expected, String actual, boolean pass) {
		System.out.println("----------------------------------------------");
		System.out.println("TC_CST_" + (tcCounter++) + " | Field: " + field);
	...
	public static void cstLogin() throws Exception
	{
		...
		// Click on Account Information link (Case Status navigation)
		...
		System.out.println("=================================================");
		System.out.println("CST2_Login - Logged in & Navigated to Account Information (Case ID: 15)");
	}
}
