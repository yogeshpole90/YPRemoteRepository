...
public class CC2_Login
{
	...
	public static void log(String field, String testDesc, String expected, String actual, boolean pass) {
		System.out.println("----------------------------------------------");
		System.out.println("TC_CC_" + (tcCounter++) + " | Field: " + field);
	...
	public String getToastMsg() {
		try { Thread.sleep(500);
			WebElement t = driver.findElement(By.cssSelector("div.msg-toast.msg-error.msg-showing em"));
	...
	public String getSuccessToastMsg() {
		try { Thread.sleep(500);
			WebElement t = driver.findElement(By.cssSelector("div.msg-toast.msg-success.msg-showing em"));
			String m = t.getText(); System.out.println(">> SUCCESS TOAST: " + m); return m;
		} catch (Exception e) { return ""; }
	}

	public void ccLogin() throws Exception
	{
		if(driver == null)
		{
		...
		// Step 6: Click Court Case Details tab (TODO: Update XPath)
		Thread.sleep(2000);
		// TODO: Court Case Details tab ka XPath yahan dalna hai
	}
