...
public class DL2_Login {
	...
	public static void log(String field, String testDesc, String expected, String actual, boolean pass) {
		System.out.println("----------------------------------------------");
		System.out.println("TC_DL_" + (tcCounter++) + " | Field: " + field);
	...
	public static void dlLogin() throws Exception
	{
		if(driver == null)
		{
		...
		WebElement docTab = driver.findElement(By.xpath("//a[contains(@href,'activeTab=Document')]"));
		...
		System.out.println("=================================================");
		System.out.println("DL2_Login - Logged in & Navigated to Document Tab (Case ID: 15)");
	}
}
