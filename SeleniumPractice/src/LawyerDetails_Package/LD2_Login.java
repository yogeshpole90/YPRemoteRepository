...
public class LD2_Login {
	...
	public static void log(String field, String testDesc, String expected, String actual, boolean pass) {
		System.out.println("----------------------------------------------");
		System.out.println("TC_LWD_" + (tcCounter++) + " | Field: " + field);
	...
	public String getToastMsg() {
		try{Thread.sleep(500);WebElement t=driver.findElement(By.xpath("//div[contains(@class,'msg-toast') and contains(@class,'msg-error')]//em"));
		String m=t.getText();System.out.println(">> ERROR TOAST: "+m);return m;}catch(Exception e){return "";}
	}
	public String getSuccessToastMsg() {
		try{Thread.sleep(500);WebElement t=driver.findElement(By.xpath("//div[contains(@class,'msg-toast') and contains(@class,'msg-success')]//em"));
		String m=t.getText();System.out.println(">> SUCCESS TOAST: "+m);return m;}catch(Exception e){return "";}
	}

	public void ldLogin() throws Exception {
		if(driver==null){
		...
		Thread.sleep(300);ld.click();Thread.sleep(1000);
		System.out.println("=================================================");
		System.out.println("LD2_Login - Logged in & Navigated to Lawyer Details Master");
	}
}
