...
public class LD22_HearingDate extends LD2_Login {

	public void validateHearingDate() throws Exception {
		List<WebElement> list = driver.findElements(By.id("hearingDate"));
		if (list.isEmpty() || !list.get(0).isDisplayed() || !list.get(0).isEnabled()) {
			logInfo("Hearing Date", "Field availability", "SKIPPED"); return;
		}
		WebElement field = list.get(0); String fn = "Hearing Date";
		String excelVal = LD_ExcelUtil.getCellData(1, 18);
