...
public class LD2_Login {
	...
	public static void log(String field, String testDesc, String expected, String actual, boolean pass) {
		System.out.println("----------------------------------------------");
		System.out.println("TC_LD_" + (tcCounter++) + " | Field: " + field);
	...
	public static void LDLogin() throws Exception
	{
		if(driver == null)
		{
		...
		// Step 5: Scroll to Legal Process tab & click
		Thread.sleep(2000);
		...
		// Step 6: Click Court Case Details tab
		Thread.sleep(2000);
	}
