...
public class LD18_CaseInitiatedByDD extends LD2_Login {

	public void validateCaseInitiatedByDD() throws Exception {
		List<WebElement> list = driver.findElements(By.xpath("//select[@id='caseInitiatedby']"));
		if (list.isEmpty() || !list.get(0).isDisplayed()) {
			logInfo("Case Initiated By", "Field availability", "SKIPPED"); return;
		}
		WebElement field = list.get(0); String fn = "Case Initiated By";
