...
public class UC13_UserCategory extends UC2_Login {

	public void validateUserCategory() throws Exception
	{
		WebElement f = driver.findElement(By.id("userTypeCode"));
		Select s = new Select(f); List<WebElement> opts = s.getOptions(); String fn = "User Category";
		...
		s.selectByVisibleText("INTERNAL USER"); String finalVal = s.getFirstSelectedOption().getText();
		log(fn, "Select 'INTERNAL USER'", "INTERNAL USER", finalVal, finalVal.equals("INTERNAL USER"));
	}
}
