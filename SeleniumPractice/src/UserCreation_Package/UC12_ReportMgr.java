...
public class UC12_ReportMgr extends UC2_Login {

	public void validateReportMgr() throws Exception
	{
		WebElement f = driver.findElement(By.id("reportingUserCode"));
		Select s = new Select(f); List<WebElement> opts = s.getOptions(); String fn = "Reporting Manager";
